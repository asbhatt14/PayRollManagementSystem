...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (isset($_POST['delete'])) {
		$employee->deleteRecords($_POST["empTempId"]);
		...
		if($valid){
			$employee->updateEmployee($_POST["empTempId"]);
			header('Location: index.php');
			exit();
		}
	}
...
function showForm(str){
  ...
  xmlhttp.open("GET","editForms.php?q="+str,true);
  xmlhttp.send();
}	
</script>
</head> 
 ...
 <body class="sticky-header left-side-collapsed">
							...
							<ul class="nav nav-pills nav-stacked custom-nav">
								...
								<li class="menu-list"><a href="forms.php"><i class="lnr lnr-pencil"></i> <span>Manage Employees</span></a>
									<ul class="sub-menu-list">
										...
										<li class="active"><a href="editForms.php">Update Employee</a></li>
									</ul>
								</li>
	...
	<!-- //header-ends -->
			...
			<div id="page-wrapper">
			<div class="tab-content" id="employeeId">
					<form class="form-horizontal" method="get">
						<div class="form-group">
							<label for="focusedinput" class="col-sm-2 control-label">Employee Id</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" name="empId" id="empId" placeholder="Enter Employee Id" onblur="showForm(this.value)">
							</div>
				...
				<div class="graphs" id="employeeDetails">
						...
						?>
						<h3 class="blank1">Update Employee Details</h3>
							<form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
							<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Employee Name</label>
									<div class="col-sm-8">
									<input type="hidden" class="form-control1" name="empTempId" id="empTempId" value="<?php echo $row['id']?>">
										<input type="text" class="form-control1" name="empName" id="empName" placeholder="Employee Name" value="<?php echo $row['name'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="datetime" class="form-control1" name="dateOfBirth" id="dateOfBirth" placeholder="YYYY-MM-DD" value="<?php echo $row['dob'];?>"
										max=<?php
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="address" id="address" placeholder="Street Address" value="<?php echo $row['address'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="city" id="city" placeholder="City" value="<?php echo $row['city'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="province" id="province" placeholder="Province" value="<?php echo $row['province'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="postalCode" id="postalCode" placeholder="Postal Code" value="<?php echo $row['zipcode'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="email" class="form-control1" name="empEmail" id="empEmail" placeholder="abc@gmail.com" value="<?php echo $row['email'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="empLinkedIn" id="empLinkedIn" placeholder="Employee LinkedIn Profile URL" value="<?php echo $row['url'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="datetime" class="form-control1" name="dateOfJoining" id="dateOfJoining" placeholder="YYYY-MM-DD" value="<?php echo $row['joinDate'];?>"
										max=<?php
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="annualPay" id="annualPay" placeholder="AnnualPay" value="<?php echo $row['basicPay'];?>">
									</div>
									<div class="col-sm-2 jlkdfj1">
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col-sm-8 col-sm-offset-2">
											<button class="btn-success btn" value="update" name="update">Update</button>
											<button class="btn-success btn" value="delete" name="delete">Delete</button>
										</div>
									</div>
								 </div>
								 <?php				 
